defmodule FoodElxproWeb.LiveHelpers do
  ...
  def modal(assigns) do
    ...
    ~H"""
    <div id="modal" class="phx-modal fade-in shadow-md rounded px-8 pt-6 pb-8 mb-4" data-role="modal" phx-remove={hide_modal()}>
      <div
            id="modal-content"
